...
### Objects
**CreateMonkeyObject** - Similar to creating a gameObject in unity, Paramaters: (**(string : objectName)**)

**GetObject** - Similar to the GameObject.Find function in unity, Paramaters: (**(string : objectName)**)
